...
The 'kingfisher_wells' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] kingfisher_wells_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/kingfisher_wells.job.yml). The schedule
